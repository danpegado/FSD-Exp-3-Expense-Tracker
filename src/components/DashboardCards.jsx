  ...
  return (
    <div className="dashboard-cards-grid">
      <div className="cyber-card metric-card">
        ...
        <h2 className={`metric-value ${balance >= 0 ? 'cyan' : 'purple'}`}>{currencySymbol} {balance.toFixed(2)}</h2>
      </div>
      ...
      <div className="cyber-card metric-card">
        ...
        <h2 className="metric-value cyan">+{currencySymbol} {income.toFixed(2)}</h2>
      </div>
      ...
      <div className="cyber-card metric-card">
        ...
        <h2 className="metric-value purple">-{currencySymbol} {expense.toFixed(2)}</h2>
      </div>
    </div>
  );
};
